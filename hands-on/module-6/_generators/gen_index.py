...
<body>
  ...
  <div class="container">
    <div class="callout">
      ...
      working agent and a trace you can read. Each lab writes to its own temp working dir (<code>biaa-lab-06-NN/</code>). Stuck? Every lab has a full answer key under <a href="solutions/"><code>solutions/</code></a>.
    </div>
