#!/usr/bin/env bash
# Regenerate all Module 4 labs, solutions, and the index landing page.
...
echo "  python -m venv /tmp/v && /tmp/v/bin/pip -q install numpy scikit-learn matplotlib nbconvert ipykernel"
