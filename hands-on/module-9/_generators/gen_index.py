...
<body>
  ...
  <div class="container">
    ...
    <div class="callout warn">
      ...
      only the <strong>standard library</strong>. You build the <strong>financial-report insight agent</strong>
      ...
      agent-assembly labs reuse the <strong>LangChain-shaped shim</strong> from Modules 6&ndash;8 (same names
      &amp; shapes), driven by a deterministic scripted model &mdash; so there are <strong>no API keys, no
      model downloads, no network</strong>. Financial math uses a small <strong>AST-based safe
